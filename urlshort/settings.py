...
try:
    ...
    try:
        ...
        try:
            import random
            SECRET_KEY = ''.join([random.SystemRandom().choice('abcdefghijklmnopqrstuvxyz0123456789!@#$%^&*(-_=+)') for i in range(50)])
...
DATABASES = {
    'default': {
        ...
        'NAME': 'urlshort',
        'USER': 'urlshortadmin',
        'PASSWORD': open(os.path.join(BASE_DIR, 'database_password.txt')).read().strip(),
        'HOST': 'localhost',
        'PORT': ''
    }
    # 'default': {
